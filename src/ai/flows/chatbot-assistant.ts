...
/**
 * @fileOverview AI-powered chatbot to provide users with instant answers to FAQs about our mission, projects, and donation processes.
 *
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a chatbot assistant for ConcernConnect, an NGO. Your goal is to provide users with instant answers to FAQs about our mission, projects, and donation processes.
