      ...
      <div className="container mx-auto px-4 py-12 md:px-6">
        <div className="grid grid-cols-1 gap-8 text-center md:grid-cols-4 md:text-left">
          <div className="md:col-span-1">
             <ConcernLogo className="mb-4 text-3xl justify-center md:justify-start"/>
            <p className="text-sm">
          ...
          <div>
            ...
            <address className="space-y-2 not-italic text-sm">
              <p className="flex items-start justify-center text-left md:justify-start">
          ...
          <div>
            <h3 className="mb-4 font-semibold text-foreground uppercase tracking-wider">Contact</h3>
             <div className="space-y-2 text-sm">
                <a href="mailto:concernrehab@gmail.com" className="flex items-center justify-center md:justify-start hover:text-primary transition-colors">
